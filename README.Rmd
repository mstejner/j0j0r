...
And on [https://mstejner.github.io/j0j0r/](https://mstejner.github.io/j0j0r/) under articles.
...
The elements of the current correlation tensor can now be calculated with the `j0j0` funnction. Here assuming a magnetic field of 2.5 T, a wave vector length of 2000/m, resolved angles of 60 and 86 degrees and frequencies between 0 and 400 MHz. 
...
```{r maxwj0j0, echo = TRUE, fig.width = 16, fig.height = 8, results = FALSE, fig.align = "center"}
