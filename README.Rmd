...
The elements of the current correlation tensor can now be calculated with the `j0j0` function. Here assuming a magnetic field of 2.5 T, a wave vector length corresponding to 3 mm waves, resolved angles of 60 and 86 degrees, and frequencies between 0 and 400 MHz. 
